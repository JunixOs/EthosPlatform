# Política de Commits — Estándar del Equipo EthosPlatform

> Documento oficial para la estandarización de commits del proyecto EthosPlatform.

- [Política de Commits — Estándar del Equipo EthosPlatform](#política-de-commits--estándar-del-equipo-ethosplatform)
...
Este documento define las reglas y convenciones oficiales para la creación de commits dentro de los repositorios del proyecto EthosPlatform.
...
```text
fix(datos): corregir migración de EF Core
```
